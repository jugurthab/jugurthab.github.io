...
$(document).ready(function(e){
		...
		function drawTracerOrProfiler(){
				...
				main_tracer_profiler = new mainContainer(linux_container_kernel.x+linux_container_kernel.width, canvasHeightTracers/3, linux_container_userspace.x - (linux_container_kernel.x+linux_container_kernel.width), canvasHeightTracers/4,"rgba(0,128,0,0.8)", "Tracer","rgba(255,255,255,1.0)");
			if($("#selectTool").val()=="profiler")		
...
console.log($("#selectTool").val());
			...
			contextTracers.fillText(main_tracer_profiler.text, main_tracer_profiler.x +8, main_tracer_profiler.y + main_tracer_profiler.height/2+8);


			main_tracer_profiler_probe = new mainContainer(main_tracer_profiler.x-50, main_tracer_profiler.y+40, 50, 50,"rgba(255,0,0,0.8)", "Probe","rgba(255,255,255,1.0)");
			...
			contextTracers.fillText(main_tracer_profiler_probe.text, main_tracer_profiler_probe.x+3 , main_tracer_profiler_probe.y+30);
		...
		function drawUserSpace(){
			linux_container_userspace = new mainContainer(canvasWidthTracers/2,120,canvasWidthTracers/3,canvasHeightTracers/2,"rgba(0,128,255,0.8)", "Userspace","rgba(255,255,255,1.0)");
		...
		function drawKernelSpace(){
			linux_container_kernel = new mainContainer(canvasWidthTracers/10,120,canvasWidthTracers/3,canvasHeightTracers/2,"rgba(0,0,255,0.8)", "Kernel","rgba(255,255,255,1.0)");
		...
		function drawLinux(){
			linux_container = new mainContainer(canvasWidthTracers/40,60,canvasWidthTracers - canvasWidthTracers/20,canvasHeightTracers/2+ canvasHeightTracers/3 -60,"rgba(255,128,255,0.5)", "Linux OS","rgba(255,255,255,1.0)");
		...
		function drawContainerMachine(){
			main_container = new mainContainer(canvasWidthTracers/50,20,canvasWidthTracers - canvasWidthTracers/30,canvasHeightTracers/2+ canvasHeightTracers/3 +20,"rgba(255,128,0,0.5)", "Host Machine","rgba(255,255,255,1.0)");
