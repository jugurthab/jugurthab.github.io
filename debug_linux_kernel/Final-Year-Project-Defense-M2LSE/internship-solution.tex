...
#define GPIO_BASE			(BCM2708_PERI_BASE + 0x200000)
		...
		\begin{figure}[H]
			\centering
        	\includegraphics[scale=0.45]{img/solution/jtag-enabler-raspberry-pi-3.png}
...
\textbf{\color{red}Important : } JTAG is enabled on Raspberry PI 3.	
		...
		\begin{figure}[H]
			\centering
        	\includegraphics[scale=0.40]{img/solution/openocd-bcm2837-launched.png}
...
\begin{figure}[H]
					\centering
        			\includegraphics[scale=0.5]{img/solution/infected-module-dumped.png}
...
Once again, this can be detected easily using basic debugging commands tools like "objdump", "readelf" or even "objcopy".
\end{enumerate}